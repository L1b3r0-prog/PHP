------------------------------------------------------
Name: Benjamin Lee
Student number(s): 8942663
Email address(es): pkbl992@uow.edu.au
...
- The website is built in plain PHP (no framework) using PHP sessions to track
  ...
  and the leaderboard.
- To run: place the folder in your PHP server's document root
  (e.g. htdocs for XAMPP) and open it.
...
| images/*.jpg | Sea animal images used in Sea World quiz |
